...
@PactTestFor(providerName = "EmployeeServiceAPI", pactVersion = PactSpecVersion.V4)
public class ConsumerPactTest {
    ...
    public V4Pact GeneratePactFor_GetAllEmployee(PactDslWithProvider builder){
    ...
    @Pact(consumer = "EmployerServiceAPI", provider = "EmployeeServiceAPI")
    public V4Pact GeneratePactFor_ReturnErrorIfEmpIdNotFoundPact(PactDslWithProvider builder){
    ...
    @Pact(consumer = "EmployerServiceAPI", provider = "EmployeeServiceAPI")
    public V4Pact GeneratePactFor_GetEmployeeByEmpID(PactDslWithProvider builder){
